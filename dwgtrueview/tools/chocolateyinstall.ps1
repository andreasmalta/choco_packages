...
if ($pp.'French') {
Write-Host "INSTALLING DWG TRUEVIEW - FRENCH"
...
$url = 'Z:\dwgtrueview\DWGTrueView_2023_French_64bit_dlm.sfx.exe'
...
elseif ($pp.'Japanese') {
Write-Host "INSTALLING DWG TRUEVIEW - JAPANESE"
...
$url = 'Z:\dwgtrueview\DWGTrueView_2023_Japanese_64bit_dlm.sfx.exe'
...
Write-Host "INSTALLING DWG TRUEVIEW - ENGLISH"
...
$url = 'Z:\dwgtrueview\DWGTrueView_2023_English_64bit_dlm.sfx.exe'

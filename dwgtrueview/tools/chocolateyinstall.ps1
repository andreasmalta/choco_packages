...
$url        = 'http://download.autodesk.com/esd/dwgtrueview/2019/DWGTrueView_2019_Enu_64bit.sfx.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'dwgtrueview*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

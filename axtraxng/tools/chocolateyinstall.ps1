...
$file_Client = Join-Path $env:TEMP 'axtraxng-master\Client\setup.exe'
...
$file_ConfigTool = Join-Path $env:TEMP 'axtraxng-master\AxTraxConfigTool\setup.exe'
...
$file_Monitor = Join-Path $env:TEMP 'axtraxng-master\Server Monitor\setup.exe'
...
$file_PreReq = Join-Path $env:TEMP 'axtraxng-master\Pre_Requisite\setup.exe'
...
$file_Server = Join-Path $env:TEMP 'axtraxng-master\Server\setup.exe'

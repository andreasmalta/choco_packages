...
$latestversion  = Join-Path $toolsDir 'setup-27.7.1.9'

$file_Client = Join-Path $latestversion 'Client\setup.exe'
...
$file_ConfigTool = Join-Path $latestversion 'AxTraxConfigTool\setup.exe'
...
$file_Monitor = Join-Path $latestversion 'Server Monitor\setup.exe'
...
$file_PreReq = Join-Path $latestversion 'Pre_Requisite\setup.exe'
...
$file_Server = Join-Path $latestversion 'Server\setup.exe'

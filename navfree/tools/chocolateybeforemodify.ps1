...
#Uninstall Autodesk Navisworks Freedom 2022 before upgrade
...
#Remove Language Packs manually since msi uninstaller not working
...
#Uninstall Material Libraries 2022 before upgrade
